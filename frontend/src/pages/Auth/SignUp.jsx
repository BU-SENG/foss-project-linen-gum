    ...
    <div className="min-h-screen bg-gray-50 flex flex-col justify-center items-center px-4 py-12">
      ...
      <div className="w-full max-w-2xl mt-16">
        ...
        <div className="bg-white rounded-lg shadow p-6 sm:p-8">
          <form onSubmit={handleSubmit}>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <button
                ...
                className={selectedRole === 'donor' ? 'p-6 rounded-lg border-2 border-blue-500 bg-blue-50' : 'p-6 rounded-lg border-2 border-gray-200 bg-white'}
              >
                <div className="flex flex-col items-center">
                  <div className={selectedRole === 'donor' ? 'w-16 h-16 rounded-full bg-blue-100 flex items-center justify-center mb-3' : 'w-16 h-16 rounded-full bg-gray-100 flex items-center justify-center mb-3'}>
              ...
              <button
                ...
                className={selectedRole === 'creator' ? 'p-6 rounded-lg border-2 border-blue-500 bg-blue-50' : 'p-6 rounded-lg border-2 border-gray-200 bg-white'}
              >
                <div className="flex flex-col items-center">
                  <div className={selectedRole === 'creator' ? 'w-16 h-16 rounded-full bg-blue-100 flex items-center justify-center mb-3' : 'w-16 h-16 rounded-full bg-gray-100 flex items-center justify-center mb-3'}>
                    <svg className="w-8 h-8 text-blue-500" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          <button className="w-full bg-blue-600 text-white py-3 rounded-lg font-semibold text-base sm:text-lg mb-4 hover:bg-blue-700">
            Create Account
          </button>
