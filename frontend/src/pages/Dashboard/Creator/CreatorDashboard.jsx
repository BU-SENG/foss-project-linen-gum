...
import { DollarSign, BarChart, Users, Clock, Info } from "lucide-react";
            ...
            <tbody>
              {campaignsData.map((campaign) => (
                <tr key={campaign.id} className="border-b hover:bg-gray-50">
                  ...
                  <td className="p-2 md:p-3 hidden lg:table-cell text-xs md:text-sm">
                    {campaign.donors}
                  </td>
                  ...
                  <td className="p-2 md:p-3 space-x-1 md:space-x-3 text-xs md:text-sm">
                    ...
                    <button className="text-gray-600 hover:underline hidden sm:inline">
                      Edit
                    </button>
                  </td>
                </tr>
